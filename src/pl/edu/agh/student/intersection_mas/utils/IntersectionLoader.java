...
public class IntersectionLoader {
    public static Intersection loadIntersection() {
        ...
        Edge edge4 = new Edge(4, node3, node5);
        Edge edge5 = new Edge(5, node5, node4);
        Edge edge6 = new Edge(6, node6, node5);
        Edge edge7 = new Edge(7, node7, node6);
        Edge edge8 = new Edge(8, node5, node9);
        Edge edge9 = new Edge(9, node7, node8);
        Edge edge10 = new Edge(10, node8, node9);
